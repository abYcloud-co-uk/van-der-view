...
export const VDV_COMMANDS: readonly CommandSpec[] = deepFreeze<CommandSpec[]>([
  ...
  },
  {
    ...
    description:
      ...
      'Useful to declutter the scene — e.g. to hide everything except a binding site, hide the ' +
      'bulk and keep the site visible. Example: { "selection": { "chain": "B" }, "visible": false }.',
    inputSchema: {
      type: 'object',
      properties: {
        selection: selectionSchema,
